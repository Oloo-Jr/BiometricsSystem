export const CountyData = [
    {"county":"UASIN GISHU","constituencies":
        [
            {
                "name":"AINABKOI","wards":
                [{"name":"KAPSOYA"},
    ...
    {"county":"LAIKIPIA","constituencies":
        [
            {
    ...
    {"county":"TANA RIVER","constituencies":
        [
            {
                "name":"GARSEN","wards":
                [{"name":"GARSEN SOUTH"},
    ...
    {"county":"KWALE","constituencies":
        [
            {
                "name":"LUNGALUNGA","wards":
                [{"name":"PONGWEKIKONENI"},
                {"name":"DZOMBO"},
                {"name":"MWERENI"},
                {"name":"VANGA"}]
    ...
    {"county":"TAITA TAVETA","constituencies":
        [
            {
                "name":"TAVETA","wards":
                [{"name":"CHALA"},
    ...
    {"county":"MARSABIT","constituencies":
        [
            {
                "name":"LAISAMIS","wards":
                [{"name":"LOIYANGALANI"},
    ...
    {"county":"THARAKA - NITHI","constituencies":
        [
            {
                "name":"MAARA","wards":
                [{"name":"CHOGORIA"},
    ...
    {"county":"WEST POKOT","constituencies":
        [
            {
    ...
    {"county":"MACHAKOS","constituencies":
        [
            {
                "name":"MWALA","wards":
                [{"name":"MBIUNI"},
    ...
    {"county":"TRANS NZOIA","constituencies":
        [
            {
                "name":"KWANZA","wards":
                [{"name":"KEIYO"},
    ...
    {"county":"NYANDARUA","constituencies":
        [
            {
                "name":"KINANGOP","wards":
                [{"name":"GATHARA"},
    ...
    {"county":"KAKAMEGA","constituencies":
        [
            {
                "name":"LURAMBI","wards":
                [{"name":"BUTSOTSO EAST"},
    ...
    {"county":"KIRINYAGA","constituencies":
        [
            {
                "name":"MWEA","wards":
                [{"name":"MURINDUKO"},
    ...
    {"county":"MURANG'A","constituencies":
        [
            {
                "name":"KANGEMA","wards":
                [{"name":"RWATHIA"},
    ...
    {"county":"ELGEYO/MARAKWET","constituencies":
        [
            {
    ...
    {"county":"KAJIADO","constituencies":
        [
            {
                "name":"KAJIADO NORTH","wards":
                [{"name":"NKAIMURUNYA"},
                {"name":"OLKERI"},
                {"name":"NGONG"},
                {"name":"ONGATA RONGAI"},
    ...
    {"county":"HOMA BAY","constituencies":
        [
            {
                "name":"KASIPUL","wards":
                [{"name":"WEST KASIPUL"},
    ...
    {"county":"NAIROBI","constituencies":
        [
            {
                "name":"DAGORETTI NORTH","wards":
                [{"name":"GATINA"},
                {"name":"KILELESHWA"},
                {"name":"KILIMANI"},
                {"name":"KAWANGWARE"},
